...
func start_hiding() -> void:
	...
	player_placeholder_sprite.self_modulate = Color8(255, 255, 255)
...
func _on_hiding_timeout() -> void:
	player.player_is_hidden = true
	player_placeholder_sprite.self_modulate = Color8(204, 76, 207)
